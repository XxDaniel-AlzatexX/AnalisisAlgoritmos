...
def test_problem_1_basic():
  assert problem_1(
      10) == 23, "La función debería retornar 23 para el límite 10"
...
def test_problem_3_basic():
  assert problem_3(
      13195
  ) == 29, "La función debería retornar 29 como el mayor factor primo de 13195"
...
def test_problem_5_basic():
  assert problem_5(
      10
  ) == 2520, "La función debería retornar 2520 como el número divisible por todos los números del 1 al 10"
